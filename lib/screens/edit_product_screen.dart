...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  Future<void> _saveForm() async {
    ...
    if (_editedData.id == null) {
      try {
        await Provider.of<Products>(context, listen: false).addProduct(_editedData);
      } catch (error) {
      ...
      await Provider.of<Products>(context, listen: false).updateProduct(_editedData.id, _editedData);
    }
    setState(() {
      isLoading = true;
    });
